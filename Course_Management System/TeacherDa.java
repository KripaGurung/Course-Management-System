...
public class TeacherDa extends JFrame {
	...
	public TeacherDa() {
		...
		lblNewLabel_7.setIcon(new ImageIcon(TeacherDa.class.getResource("/CMS/icons/Dashbord.png")));
		lblNewLabel_7.setBounds(34, 60, 45, 47);
		panel.add(lblNewLabel_7);
		
		JLabel lblNewLabel_9 = new JLabel("New label");
		lblNewLabel_9.setIcon(new ImageIcon(TeacherDa.class.getResource("/CMS/icons/assignment (1).png")));
		lblNewLabel_9.setBounds(34, 147, 45, 38);
		panel.add(lblNewLabel_9);
		
		JLabel lblNewLabel_10 = new JLabel("New label");
		lblNewLabel_10.setIcon(new ImageIcon(TeacherDa.class.getResource("/CMS/icons/best (1).png")));
		lblNewLabel_10.setBounds(34, 219, 45, 47);
		panel.add(lblNewLabel_10);
		
		JLabel lblNewLabel_11 = new JLabel("New label");
		lblNewLabel_11.setIcon(new ImageIcon(TeacherDa.class.getResource("/CMS/icons/logout (1).png")));
