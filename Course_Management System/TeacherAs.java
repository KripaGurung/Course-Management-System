...
public class TeacherAs extends JFrame {
	...
	public TeacherAs() {
		...
		lblNewLabel_7.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/Dashbord.png")));
		lblNewLabel_7.setBounds(34, 60, 45, 47);
		panel.add(lblNewLabel_7);
		
		JLabel lblNewLabel_9 = new JLabel("New label");
		lblNewLabel_9.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/assignment (1).png")));
		lblNewLabel_9.setBounds(34, 168, 45, 38);
		panel.add(lblNewLabel_9);
		
		JLabel lblNewLabel_10 = new JLabel("New label");
		lblNewLabel_10.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/best (1).png")));
		lblNewLabel_10.setBounds(34, 247, 45, 47);
		panel.add(lblNewLabel_10);
		
		JLabel lblNewLabel_11 = new JLabel("New label");
		lblNewLabel_11.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/logout (1).png")));
		...
		JLabel lblNewLabel_1 = new JLabel("Define OOP concept.");
		...
		btnNewButton_5.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/upload-big-arrow (1).png")));
		...
		btnNewButton_6.setIcon(new ImageIcon(TeacherAs.class.getResource("/CMS/icons/close (1).png")));
