...
public class StudentAs extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private static JTextField textField; // Declare textField as a class field
	...
	public StudentAs() {
		...
		lblNewLabel_6.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/Dashbord.png")));
		lblNewLabel_6.setBounds(22, 54, 45, 41);
		panel_1.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("");
		lblNewLabel_7.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/teacher.png")));
		lblNewLabel_7.setBounds(22, 118, 45, 41);
		panel_1.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("");
		lblNewLabel_8.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/book (1).png")));
		lblNewLabel_8.setBounds(22, 187, 45, 41);
		panel_1.add(lblNewLabel_8);
		
		JLabel lblNewLabel_9 = new JLabel("New label");
		lblNewLabel_9.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/assignment (1).png")));
		...
		lblNewLabel_15.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/best (1).png")));
		lblNewLabel_15.setBounds(22, 339, 45, 41);
		panel_1.add(lblNewLabel_15);
		
		JLabel lblNewLabel_10 = new JLabel("");
		lblNewLabel_10.setIcon(new ImageIcon(StudentAs.class.getResource("/CMS/icons/logout (1).png")));
		...
		JLabel lblNewLabel_1 = new JLabel("View Assignment of:");
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 30));
		lblNewLabel_1.setBounds(349, 159, 313, 35);
		panel.add(lblNewLabel_1);
		  ...
		  comboBox = new JComboBox<String>();
	        ...
	        comboBox.setBorder(new LineBorder(new Color(100, 149, 237)));
	        comboBox.setFont(new Font("Times New Roman", Font.BOLD, 20));
	        comboBox.setBounds(635, 159, 313, 35);
	        panel.add(comboBox);
	        ...
	        textField.setBounds(345, 299, 336, 218);
	        panel.add(textField);
	        textField.setColumns(10);
		
		JButton btnNewButton_6 = new JButton("Do Assigment");
		btnNewButton_6.setBackground(new Color(100, 149, 237));
		btnNewButton_6.setForeground(new Color(0, 0, 0));
		btnNewButton_6.setFont(new Font("Times New Roman", Font.BOLD, 20));
		btnNewButton_6.setBounds(727, 577, 200, 40);
		panel.add(btnNewButton_6);
	}
	  private static void setToTextFld() {
	        // Update the textField based on the selected item
	        String selectedItem = (String) comboBox.getSelectedItem();
	        String content = getContent(selectedItem);
	        textField.setText(content);
	    }
	  
	  
	   private static String getContent(String selectedItem) {
	        switch (selectedItem) {
	            case "JAVA":
	            
	                return "Question 1:What is Inheritance?";
	                
	            case "PYTHON":
	                return "Question 1:What is Tuple?";
	            case "PHP":
	                return "Question 1:What are references in PHP?";
	            case "C":
	                return "Question 1:What is Void Pointer?";
	            default:
